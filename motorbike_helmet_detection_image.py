...
def check_each_img(x):
    category_index_helmet, image_helmet, boxes_helmet, scores_helmet, classes_helmet, num_helmet = \
        detection('frozen_graphs', '/frozen_inference_graph_helmet.pb', '/labelmap_helmet.pbtxt', 2, x)
    ...
    category_index_motorbike, image_helmet, boxes_motorbike, scores_motorbike, classes_motorbike, num_motorbike = \
        detection('frozen_graphs', '/frozen_inference_graph_motorbike.pb', '/labelmap_motorbike.pbtxt', 4, x)
