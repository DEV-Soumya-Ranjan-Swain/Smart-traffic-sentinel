...
def detection(helmet_inference_path, frozen_graph_path, labelmap, number_of_classes, input):
    ...
    image = cv2.resize(image, (600, 600))  # 1080,1080
...
def detection2(helmet_inference_path, frozen_graph_path, labelmap, number_of_classes, frame):
    detection_graph = tf.Graph()
    # Name of the directory containing the object detection module we're using
    TRAINED_MODEL_DIR = helmet_inference_path
    ...
    return category_index, frame, boxes, scores, classes, num
